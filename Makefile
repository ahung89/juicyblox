OBJS = juicyblox_main.o grid.o constants.o block.o color.o
OBJ_NAME = juicyblox
CC = g++
...
juicyblox_main.o : src/juicyblox_main.cpp src/block.h src/constants.h src/game_object.h
...
grid.o : src/grid.cpp src/grid.h src/constants.h src/util/color.h
...
block.o : src/block.cpp src/block.h src/block_shape.h src/game_object.h src/point.h src/util/color.h
	$(CC) $(INCLUDE_PATHS) $(COMPILER_FLAGS) -c src/block.cpp

color.o : src/util/color.cpp src/util/color.h
	$(CC) $(INCLUDE_PATHS) $(COMPILER_FLAGS) -c src/util/color.cpp